...
Escribe un programa que comience leyendo el número de barras vendidas que no son del día. Después tu programa debe mostrar el precio habitural de una barra de pan, el descuento que se le hace por no ser fresca y el coste final total.
"""
